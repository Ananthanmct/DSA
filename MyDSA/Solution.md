# Kubernetes Assignment Set 1 - Solution Guide

This document provides a step-by-step guide for solving the Kubernetes hands-on assignment. You can directly copy this into your GitHub `README.md` file.

---

## Objective

Deploy a multi-tier enterprise-grade application on Kubernetes using Helm, implement configuration and security best practices, and simulate real-world infrastructure scenarios.
...
* Update parent `Chart.yaml` to add dependencies:
...
### Reference ServiceAccount in your deployment
...
### Local hostPath (Minikube/dev only)
...
* GitHub repo with:
  ...
  * YAMLs: ConfigMap, Secrets, PVCs, NetworkPolicy, RBAC, Probes, CronJob
* Screenshots:

  * `kubectl get all`
  * `helm list`
  * CronJob output log (via `kubectl logs`)
